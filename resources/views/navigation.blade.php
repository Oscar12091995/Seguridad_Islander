...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	...
	<div class="md:hidden sm:block w-full bottom-4 right-4 items-center overflow-hidden fixed z-50 duration-500 transform hover:-translate-y-3">
		<a class="sm:hidden float-right block items-center text-center justify-center w-10 h-10 rounded-full border bg-blue-900 text-white text-3xl" href="tel:+528211009115"><i class="fas fa-phone-alt"></i></a>
	</div>
