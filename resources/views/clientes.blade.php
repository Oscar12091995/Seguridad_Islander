...
<section class="w-full mt-12">
    <div class="container flex flex-col items-center px-5 mx-auto  md:flex-row lg:px-28">
        ...
        <h1 class="mb-2 text-2xl font-black tracking-tighter text-blue-900  md:text-5xl title-font wow animated zoomIn "> Compromiso </h1>
        ...
        <img class="object-cover object-center rounded-lg" alt="hero" src="{{asset('images/pexels-sora-shimazaki-5673488.jpg')}}">
        </div>
    </div>
</section>
